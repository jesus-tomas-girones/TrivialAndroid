...
public class SecondLevelNodeViewBinder extends CheckableNodeViewBinder {
    ...
    public SecondLevelNodeViewBinder(View itemView, CategorySelectionTreeViewFragment.OnCheckBoxClickListener onCheckBoxListener) {
        super(itemView);
    ...
    public int getLayoutId() {
        return R.layout.treeview_item_second_level;
    }
