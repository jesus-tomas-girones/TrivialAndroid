...
class EveryLevelNodeViewBinderOdd extends CheckableNodeViewBinder {
    private final ImageView imageView;
    private final TextView textView;
    private final Context mContext;
    private final CategorySelectionTreeViewFragment.OnCheckBoxClickListener mOnCheckBoxListener;

    public EveryLevelNodeViewBinderOdd(View itemView, CategorySelectionTreeViewFragment.OnCheckBoxClickListener onCheckBoxListener) {
        super(itemView);
    ...
    public int getLayoutId() {
        return R.layout.treeview_item_odd_level;
    }
